...
class SelfTestQuestionsScreen extends StatefulWidget {
  const SelfTestQuestionsScreen({
  ...
  @override
  State<SelfTestQuestionsScreen> createState() =>
      _SelfTestQuestionsScreenState();
...
class _SelfTestQuestionsScreenState
    extends State<SelfTestQuestionsScreen> with TickerProviderStateMixin {
  ...
  Future<void> submitAnswer(String submittedAnswer) async {
    context.read<QuestionsCubit>().updateQuestionWithAnswerAndLifeline(
          ...
          context
              ...
              .quizCorrectAnswerCreditScore(QuizTypes.SelfTest),
          context
              .read<SystemConfigCubit>()
              .quizWrongAnswerDeductScore(QuizTypes.SelfTest),
        ); //change question

...
import 'package:flutterquiz/ui/screens/quiz_language_selection_screen.dart';
...
class Routes {
  ...
  static const SelfTestQuestions = '/SelfTestQuestions';
  ...
  static const quizLanguageSelect = '/quiz-language-select';
  ...
  static Route<dynamic>? onGenerateRouted(RouteSettings routeSettings) {
    ...
    switch (routeSettings.name) {
      ...
      case multiMatchQuiz:
        return MultiMatchQuizScreen.route(routeSettings);
      case multiMatchResultScreen:
        return MultiMatchResultScreen.route(routeSettings);
      case multiMatchReviewScreen:
        return MultiMatchReviewScreen.route(routeSettings);
      case wallet:
      ...
      case SelfTest:
        return SelfTestScreen.route(routeSettings);
      case SelfTestQuestions:
        return SelfTestQuestionsScreen.route(routeSettings);
      case category:
      ...
      case quizLanguageSelect:
        return QuizLanguageSelectionScreen.route();
      default:

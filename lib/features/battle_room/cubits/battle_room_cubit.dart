...
class BattleRoomCubit extends Cubit<BattleRoomState> {
    ...
    try {
      ...
      if (documents.isNotEmpty) {
        ...
        if (searchAgain) {
          ...
          subscribeToBattleRoom(room.id, questions, isTeamBattle: false);
        }
      } else {
        await createRoom(
          categoryId: categoryId,
  ...
  Future<void> joinRoom({
    ...
    try {
      ...
      subscribeToBattleRoom(roomId, questions, isTeamBattle: false);
    } on Exception catch (e) {
      emit(BattleRoomFailure(e.toString()));
    }
  }
  ...
  void deleteBattleRoom() {
    if (state is BattleRoomUserFound) {
      ...
      _battleRoomRepository
        ...
        ..deleteBattleRoom(battleRoom.roomId, isTeamBattle: false);

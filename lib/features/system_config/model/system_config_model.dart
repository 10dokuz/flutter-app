...
class SystemConfigModel {
  SystemConfigModel({
    ...
    required this.SelfTestMode,
    required this.SelfTestMaxMinutes,
    ...
    required this.TeamBattleRoomCodeCharType,
    required this.TeamBattleCorrectAnswerCreditScore,
    required this.TeamBattleTimer,
    required this.TeamBattleWrongAnswerDeductScore,
    ...
    required this.TeamBattleQuickestCorrectAnswerExtraScore,
    required this.TeamBattleSecondQuickestCorrectAnswerExtraScore,
    ...
    required this.SelfTestMaxQuestions,
    required this.TeamBattleMinimumEntryFee,
  ...
  SystemConfigModel.fromJson(Map<String, dynamic> json) {
    ...
    TeamBattleMode = json['battle_mode_group'] == '1';
    ...
    SelfTestMode = json['self_challenge_mode'] == '1';
    ...
    TeamBattleRoomCodeCharType = RoomCodeCharType.fromString(
  ...
  late bool SelfTestMode;
  late int SelfTestMaxMinutes;
  late int SelfTestMaxQuestions;
  ...
  late final RoomCodeCharType TeamBattleRoomCodeCharType;
  ...
  late final int TeamBattleTimer;
  late final int TeamBattleMinimumEntryFee;
  late final int TeamBattleCorrectAnswerCreditScore;
  late final int TeamBattleWrongAnswerDeductScore;
  late final int TeamBattleQuickestCorrectAnswerExtraScore;
  late final int TeamBattleSecondQuickestCorrectAnswerExtraScore;

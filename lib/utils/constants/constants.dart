...
const predefinedMessages = [
  ...
  'This battle is gonna be legendary! ',
  'You vs Me… Let’s see who wins! ',
  'You’ll need some luck for this one… ',
  'No one saw that coming! ',
  'Victory is my middle name! ',
  'We’re just getting started! ',
  'Believe in yourself, challenger! ',
  'Use your brain, not just your brawn! ',
  'Make your final move, brave warrior! ',
  'This is a real challenge! ',
  'Be quick, or be defeated! ',
  'You almost had me! ',
  'Wanna try again? ',
];
...
final payoutMethods = [
  ...
  PayoutMethod(
    ...
    inputs: [
      (
      name: 'mail adress', // Name for the field
